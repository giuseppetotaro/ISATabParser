...
public class ISATabInvestigationParserTest {

	@Test
	public void testParseInvestigation() throws Exception {
		String path = "/test-documents/testISATab_BII-I-1/i_investigation.txt";
		...
		try {
			stream = ISATabInvestigationParserTest.class.getResourceAsStream(path);
